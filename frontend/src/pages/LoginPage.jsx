...
const LoginPage = ()=>{
    ...
    return(
        ...
        className="max-w-md w-full bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl shadow-xl overflow-hidden
        rounded-2xl"
        >
        <div className="p-8">
        <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-green-400 to-emerald-400
        ...
        <form onSubmit={handleLogin}>
            ...
            whileTap={{scale:0.80}}
            className="max-w-40 w-full py-3 px-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white font-bold
        ...
        <div className="px-8 py-4 bg-gray-900 bg-opacity-50 flex justify-center">
            <p className="text-sm text-gray-400">
                ...
                <Link to="/signup"  reloadDocument  className="text-green-400 hover:underline">SignUp</Link>
            </p>
        </div>
        </motion.div>
    );
